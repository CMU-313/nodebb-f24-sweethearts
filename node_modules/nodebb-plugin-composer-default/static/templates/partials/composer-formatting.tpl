<div class="d-flex justify-content-between gap-2 align-items-center formatting-bar m-0">
	...
	<div class="d-flex align-items-center gap-1">
		...
		<button class="btn btn-sm btn-link py-2 text-body fw-semibold text-nowrap" data-action="toggleAnonymous">
			<input type="checkbox" class="checkbox" id="anonymous-toggle">
			<label for="anonymous-toggle" class="switch"></label>
			Anonymous
		</button>
